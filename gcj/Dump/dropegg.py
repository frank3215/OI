...
def min_attempts_egg_drop_recursive(eggs, floors):
    ...
    for floor in range(1, floors + 1):
        min_value = min(min_value,1 + max(min_attempts_egg_drop_recursive(eggs - 1, floor - 1),min_attempts_egg_drop_recursive(eggs, floors - floor)))
        print min_value
...
if __name__ == '__main__':
    #eggs = 5
    #floors = 100
    #ma = min_attempts_egg_drop(eggs, floors)
    #print ma

    eggs = 2
    floors = 5
    ma = min_attempts_egg_drop_recursive(eggs, floors)
    print ma
